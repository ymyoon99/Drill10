...
class StateMachine:
    def __init__(self, boy):
        ...
        self.transitions = {
            ...
            Sleep: {right_down: Run, left_down: Run, right_up: Run, left_up: Run}  # 더이상 space_down이 필요없음.
        }
...
class Boy:
    ...
    def fire_ball(self):
        ...
        game_world.add_object(ball, 1) # 공을 1번 레이어에 추가
